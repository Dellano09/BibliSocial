...
<div class="login-box">
  <div class="login-logo">
    <a href="/dellano/home"><b>Bibli</b>Social</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Fazer Login</p>

    <form action="/dellano/login/logar" method="post">
    ...
    <a href="cadastrar" class="text-center">Eu não tenho cadastro</a>
...
<!-- iCheck -->
<script src="/dellano/includes/plugins/iCheck/icheck.min.js"></script>
